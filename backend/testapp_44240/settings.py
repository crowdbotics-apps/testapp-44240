"""
Django settings for testapp_44240 project.
...
ROOT_URLCONF = 'testapp_44240.urls'
...
WSGI_APPLICATION = 'testapp_44240.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapp_44240 API",
    "DESCRIPTION": "API documentation for testapp_44240 App",
    "VERSION": "v1",
}
